...
public class EntityTestFX extends EntityFX
{

	float particleScaleOverTime;


	public EntityTestFX(World par1World, double par2, double par4, double par6, float par8, float par9, float par10)
	{
		this(par1World, par2, par4, par6, par8, par9, par10, 2.0F);
	}

	public EntityTestFX(World par1World, double par2, double par4, double par6, double par8, double par10, double par12, float par14)
	{
