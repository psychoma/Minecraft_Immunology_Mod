	...
	public static EntityFX spawnParticle(String particleName, double par2, double par4, double par6, double par8, double par10, double par12)
	{
		if(mc != null && mc.renderViewEntity != null && mc.effectRenderer != null)
		{
			...
			else
			{
				...
				{
					var21 = new EntityTest2FX(theWorld, par2, par4, par6, (float)par8, (float)par10, (float)par12);
				}
				if(particleName.equals("chickenPox"))
				{
					var21 = new EntityChickenPoxFX(theWorld, par2, par4, par6, (float)par8, (float)par10, (float)par12);
				}
				if(var21 != null)
				{
