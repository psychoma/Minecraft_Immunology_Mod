...
public abstract class EntityLiving extends Entity
{
    ...
    private boolean diseaseNeedUpdate = true;
    ...
    public void writeEntityToNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        if(!this.activeDiseasesMap.isEmpty())
        {
        	...
        	par1NBTTagCompound.setTag("ActiveDiseases", var6);
        }
    ...
    public void readEntityFromNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        {
        	var2 = par1NBTTagCompound.getTagList("ActiveDiseases");
        	for(var3 = 0; var3 < var2.tagCount(); ++var3)
        	{
        		NBTTagCompound var4 = (NBTTagCompound)var2.tagAt(var3);
    ...
    {
        if (this.activeDiseasesMap.containsKey(Integer.valueOf(par1Disease.getdiseaseID())))
        {
            ((Disease)this.activeDiseasesMap.get(Integer.valueOf(par1Disease.getdiseaseID()))).combine(par1Disease);
                this.onChangedDisease((Disease)this.activeDiseasesMap.get(Integer.valueOf(par1Disease.getdiseaseID())));
        }
        else
        {
        	
            this.activeDiseasesMap.put(Integer.valueOf(par1Disease.getdiseaseID()), par1Disease);
            this.onNewDisease(par1Disease);
        }
    }
    /**
     * When disease is changed/combined update is set to true
     */
    protected void onChangedDisease(Disease par1Disease)
    {
    	System.out.println("Disease Changed");
        this.diseaseNeedUpdate = true;
    }
    /**
     * When new disease is added set a variable to update
     * @param par1Disease
     */
    protected void onNewDisease(Disease par1Disease)
    {
    ...
    protected void updateDiseases()
    {
        ...
        if (this.diseaseNeedUpdate)
        {

            this.diseaseNeedUpdate= false;
        }
    }
    /**
    ...
    public int[] getDiseaseEffects()
    {
    	...
    	{
    		effects[listeffects.get(j)] = listeffects.get(j);
    	}
    ...
    public float getSpeedModifier()
    {
        ...
        if(this.isDiseaseActive(Disease.commonCold))
        {
        	var1 *= 1.0F - 0.1F;
        }
